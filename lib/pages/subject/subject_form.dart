...
class _SubjectFormPageState extends State<SubjectFormPage> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              ...
              RaisedButton.icon(
                icon: Icon(Icons.save),
                color: widget.isCreate ? themeData.accentColor : _subject.color,
  ...
  bool _saveSubject() {
    ...
    form.save();
    if (widget.isCreate) {
      _subjectBloc.dispatch(AddSubject(_subject));
    } else {
      _subjectBloc.dispatch(UpdateSubject(_subject));
    }
    return true;
  }
