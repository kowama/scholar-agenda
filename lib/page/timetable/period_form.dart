...
//      subjects: _fetchSubjects(), period: isCreate ? Period() : period);
//
//  Future<List<Subjects>> _fetchSubjects() async {
//    return await dbService.subject.getAll();
//  }
//}
//
...
//  final dbService = DbService();
//  final Future<List<Subjects>> subjects;
//
//  Period period;
